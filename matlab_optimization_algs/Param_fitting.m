...
%parámetros de acoplamiento, pero asociados a la salida "out1" que es la
...
%Valores iniciales de parámetros para la iteración. Pero como se trata de
...
%DEFINICION DEL MODELO, función de parámetros (x) y puntos de variables
...
%-------------------------------------------------------------------------%
%-------------------------------------------------------------------------%
%% Ajuste Paramétrico de Inserción:
%Se tratará de ajustar paramétricamente curvas que representen a la
%Potencia transmitida a través del divisor hacia el divisor siguiente, es 
%decir, considerando las reflexiones, o la pérdida de inserción.
%Para esto se utiliza el método de ajuste por mínimos cuadrados con
%lsqcurvefitting. Las variables independientes son 3: b1, br, f
%Los parámetros son 2.
...
%función de parámetros (x) y puntos de variables
%independientes (x_var). Cabe destacar que los nombres son derivados de la
%nomenclatura usada en MATLAB.
